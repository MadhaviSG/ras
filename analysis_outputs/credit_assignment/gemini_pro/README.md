...
**Annotator:** `gateway:gemini/gemini-2.5-pro`

**Sample size:** 70 trajectories (808 steps).

**Real model called: yes.** Completer id: `gateway:gemini/gemini-2.5-pro`.
...
- proposed-high steps: 102
- of those that touch a sink: 47
- of those that do not: 55
- fraction of proposed-high that are sinks: 0.46078431372549017
...
completer: gateway:gemini/gemini-2.5-pro
n_trajectories: 70
n_steps: 808

proposed labels vs live baselines (y_true=baseline, y_pred=proposed)
  vs sink_outcome_oracle: n=808 acc=0.882 P=0.461 R=0.540 F1=0.497 tp=47 fp=55 tn=666 fn=40
  vs keyword: n=808 acc=0.859 P=0.010 R=0.071 F1=0.017 tp=1 fp=101 tn=693 fn=13
  vs sink_presence: n=808 acc=0.781 P=0.461 R=0.278 F1=0.347 tp=47 fp=55 tn=584 fn=122

trajectory-outcome AUROC (grader rule_based)
  task_identity (out-of-fold): 0.576
  task_identity (in-sample, memorises task id): 0.989
  action-level (max credit): 0.457
  action-level beats task_identity: False
...
online rows (cummax) — * = required baseline
  ...
  llm_credit: 35 harmful, prefix-AUROC @0.25=0.657  @0.50=0.729  @0.75=0.829  @1.00=0.971
